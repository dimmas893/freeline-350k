        ...
        <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="my-2">
                    ...
                    <input type="integer" name="no_telp" class="form-control" placeholder="Masukan No Telfon Suplier">
                </div>
                <div class="my-2">
  ...
  <div class="modal-content">
    ...
    <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
      ...
      <div class="modal-body">
            ...
            <div class="my-2">
                <label for="no_telp">No Telpon</label>
                <input type="integer" id="no_telp" name="no_telp" class="form-control" placeholder="Masukan No Telfon Suplier">
            </div>
            <div class="my-2">
                <label for="keterangan">Keterangan</label>
      ...
      <div class="section-body">
        <div class="row my-5">
            ...
            <div class="card shadow">
                ...
                <h3 class="text-light">Tabel Suplier</h3>
                <button class="btn btn-light" data-toggle="modal" data-target="#add_TU_modal"><i
                    class="bi-plus-circle me-2"></i>Tambah Suplier</button>
                </div>
