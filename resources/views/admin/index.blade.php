        ...
        <form action="#" method="POST" id="add_TU_form" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="my-2">
                    ...
                    <input type="text" name="nomor_induk_pegawai" class="form-control" placeholder="Masukan Nomor Induk Pegawai" required>
                </div>
                <div class="my-2">
                    <label for="nama_admin">Nama Pegawai</label>
  ...
  <div class="modal-content">
    ...
    <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
      ...
      <div class="modal-body">
            <div class="my-2">
                <label for="nomor_induk_pegawai">Nomor Induk Pegawai</label>
                <input type="text" id="nomor_induk_pegawai" name="nomor_induk_pegawai" class="form-control" placeholder="Masukan Nomor Induk Pegawai" required>
            </div>
            <div class="my-2">
                <label for="nama_admin">Nama Pegawai</label>
                <input type="text" id="nama_admin" name="nama_admin" class="form-control" placeholder="Masukan Nama" required>
            </div>
    ...
    $(function() {
      ...
      $(document).on('click', '.editIcon', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            $("#nomor_induk_pegawai").val(response.nomor_induk_pegawai);
